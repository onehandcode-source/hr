                ...
                {!evaluations || evaluations.length === 0 ? (
                  ...
                  evaluations.map((ev) => (
                    <TableRow key={ev.id} hover>
                      ...
                      <TableCell>{ev.user.department} / {ev.user.position}</TableCell>
                        ...
                        <Table>
                          <TableHead>
                            <TableRow>
                              ...
                              <TableCell width="150px">점수 (최대 {categoryItems[0]?.maxScore})</TableCell>
                              ...
                              <TableRow key={item.id}>
                                ...
                                <TableCell>
                                  <TextField
                                    type="number"
                                    size="small"
                                    slotProps={{ htmlInput: { min: 0, max: item.maxScore, step: 0.5 } }}
