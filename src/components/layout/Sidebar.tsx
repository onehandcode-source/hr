...
const menuItems: MenuItem[] = [
  ...
  { text: '전체 일정', href: '/admin/calendar', icon: <CalendarMonthIcon fontSize="small" />, roles: ['ADMIN'] },
  { text: '대시보드', href: '/employee', icon: <DashboardIcon fontSize="small" />, roles: ['EMPLOYEE'] },
